...
extension PioneerMenuController: SlideOutMenuViewControllerDelegate {
    ...
    func didSelectMenuOption(index: Int) {
        ...
        switch index {
        case 0:
            centerNavigationController.viewControllers = [MenuOptions.viewControllers[0]]
            break
        default:
            if index == MenuOptions.viewControllers.count - 1 {
                //LOGOUT ACTIONS HERE
                print("logging out...")
                let defaults = UserDefaults.standard
                defaults.set(nil, forKey: UserDefaultKeys.userEmailKey.rawValue)
                defaults.set(nil, forKey: UserDefaultKeys.userTokenKey.rawValue)
                handleLogout()
            } else {
                MenuOptions.viewControllers[index].navigationItem.leftBarButtonItem = leftMenuButton()
            }
        }
        toggleLeftPanel()
//        switch type {
//            case .home:
//                toggleLeftPanel()
//                centerNavigationController.viewControllers = [homeViewContainer]
//            case .favorites:
//                toggleLeftPanel()
//                favoritesViewContainer.navigationItem.leftBarButtonItem = leftMenuButton()
//                centerNavigationController.viewControllers = [favoritesViewContainer]
//            case .settings:
//                toggleLeftPanel()
//                settingsViewController.navigationItem.leftBarButtonItem = leftMenuButton()
//                centerNavigationController.viewControllers = [settingsViewController]
//            case .support:
//                toggleLeftPanel()
//                supportViewController.navigationItem.leftBarButtonItem = leftMenuButton()
//                centerNavigationController.viewControllers = [supportViewController]
//
//            case .logout:
//                print("logging out...")
//                let defaults = UserDefaults.standard
//                defaults.set(nil, forKey: UserDefaultKeys.userEmailKey)
//                defaults.set(nil, forKey: UserDefaultKeys.userTokenKey)
//                handleLogout()
//        }
    }
}
